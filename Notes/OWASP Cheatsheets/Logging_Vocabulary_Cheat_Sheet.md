...
source_url: "https://cheatsheetseries.owasp.org/cheatsheets/Logging_Vocabulary_Cheat_Sheet.html"
created: "1741872881.9943898"
tags: [owasp, cheatsheet, security]
---
# Logging Vocabulary

## Application Logging Vocabulary Cheat Sheet[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[¶](#exclusions)](#user_deleteduseridonuserid)](#user_archiveduseridonuserid)](#user_updateduseridonuseridattributesonetwothree)](#user_createduseridnewuseridattributesonetwothree)](#user-management-user)](#sys_monitor_enableduseridmonitor)](#sys_monitor_disableduseridmonitor)](#sys_crashreason)](#sys_restartuserid)](#sys_shutdownuserid)](#sys_startupuserid)](#system-events-sys)](#session_use_after_expireuserid)](#session_expireduseridreason)](#session_reneweduserid)](#session_createduserid)](#session-management-session)](#sequence_failuserid)](#sequence-errors-sequence)](#sensitive_deleteuseridfileobject)](#sensitive_updateuseridfileobject)](#sensitive_readuseridfileobject)](#sensitive_createuseridfileobject)](#sensitive-data-changes-data)](#privilege_permissions_changeduseridfileobjectfromleveltolevel)](#privilege-changes-privilege)](#malicious_direct_referenceuseridip-useragent)](#malicious_corsuseridipuseragentreferer)](#malicious_attack_tooluseridiptoolnameuseragent)](#malicious_extraneoususeridipinputnameuseragent)](#malicious_excess_404useridipuseragent)](#malicious-behavior-malicious)](#input_validation_failfielduserid)](#input-validation-input)](#upload_deleteuseridfileid)](#upload_validationfilenamevirusscanimagemagickfailedincompletepassed)](#upload_storedfilenamefromto)](#upload_completeuseridfilenametype)](#file-upload-upload)](#excess_rate_limit_exceededuseridmax)](#excessive-use-excess)](#authz_adminuseridevent)](#authz_changeuseridfromto)](#authz_failuseridresource)](#authorization-authz)](#authn_token_deleteappid)](#authn_token_reuseuseridtokenid)](#authn_token_revokeduseridtokenid)](#authn_token_createduserid-entitlements)](#authn_impossible_traveluseridregion1region2)](#authn_password_change_failuserid)](#authn_password_changeuserid)](#authn_login_lockuseridreason)](#authn_login_fail_maxuseridmaxlimitint)](#authn_login_failuserid)](#authn_login_successafterfailuseridretries)](#authn_login_successuserid)](#authentication-authn)](#the-vocabulary)](#format)](#identifying-events)](#getting-started)](#assumptions)](#overview)](#application-logging-vocabulary-cheat-sheet)
