...
## Kubernetes Security Cheat Sheet[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[¶](#references)](#leverage-the-context-that-kubernetes-provides-to-prioritize-remediation-efforts)](#use-kubernetes-native-security-controls-to-reduce-operational-risk)](#embed-security-into-the-container-lifecycle-as-early-as-possible)](#section-5-final-thoughts)](#events)](#cluster-logging)](#node-logging)](#container-logging)](#understanding-logging)](#define-audit-policies)](#audit-logs)](#enable-audit-logging)](#logging)](#rotate-infrastructure-credentials-frequently)](#if-breached-scale-suspicious-pods-to-zero)](#monitor-network-traffic-to-limit-unnecessary-or-insecure-communication)](#compare-and-analyze-different-runtime-activity-in-pods-of-the-same-deployments)](#preventing-containers-from-loading-unwanted-kernel-modules)](#container-sandboxing)](#container-runtime-security)](#use-pod-security-admission-to-prevent-risky-containerspods-from-being-deployed)](#section-5-kubernetes-security-best-practices-runtime-phase)](#finding-exposed-secrets)](#alternatives-to-kubernetes-secret-resources)](#encrypt-secrets-at-rest)](#keep-secrets-as-secrets)](#securing-data)](#use-kubernetes-network-policies-to-control-traffic-between-pods-and-clusters)](#limiting-resource-usage-on-a-cluster)](#opa-for-service-mesh-authorization)](#opa-for-kubernetes-admission-control)](#opa-for-application-authorization)](#most-common-use-cases-of-opa)](#implementing-centralized-policy-management)](#disadvantages-of-the-security-mesh)](#advantages-of-a-service-mesh)](#providing-extra-security-with-a-service-mesh)](#use-pod-security-policies-to-control-the-security-related-attributes-of-pods-which-includes-container-privilege-levels)](#utilize-pod-security-standards-and-the-built-in-pod-security-admission-controller-to-enforce-container-privilege-levels)](#continuously-assess-the-privileges-used-by-containers)](#security-context-example-a-pod-definition-that-includes-security-context-parameters)](#apply-security-context-to-your-pods-and-containers)](#implement-continuous-security-vulnerability-scanning)](#use-the-imagepolicywebhook-to-govern-image-provenance)](#setting-the-namespace-preference)](#setting-the-namespace-for-a-request)](#code-that-uses-namespaces-to-isolate-kubernetes-resources)](#section-4-kubernetes-security-best-practices-deploy-phase)](#use-distroless-or-empty-images-when-possible)](#minimize-features-in-all-cis)](#use-a-ci-pipeline-to-control-and-identify-vulnerabilities)](#only-use-authorized-images-in-your-environment)](#ensure-that-cis-are-up-to-date)](#what-is-a-container-image)](#section-3-kubernetes-security-best-practices-build-phase)](#limiting-access-to-the-kubelets)](#implementing-role-based-access-control-in-kubernetes)](#options-for-kubernetes-built-in-api-authentication-not-recommended)](#external-api-authentication-for-kubernetes-recommended)](#how-kubernetes-handles-api-authorization)](#controlling-access-to-the-kubernetes-api)](#controlling-network-access-to-sensitive-ports)](#limiting-access-to-the-primary-etcd-instance)](#restricting-access-to-etcd-important)](#securing-the-kubernetes-dashboard)](#section-2-securing-kubernetes-components)](#release-schedule-for-kubernetes)](#updating-kubernetes)](#section-1-securing-kubernetes-hosts)](#node-components)](#control-plane-components)](#introduction-what-is-kubernetes)](#receive-alerts-for-security-updates-and-reporting-vulnerabilities)](#overview)](#kubernetes-security-cheat-sheet)
### Overview¶
...
- Do not expose the dashboard without additional authentication to the public. There is no need to access such a powerful tool from outside your [[_content/dictionary#L|LAN]]
...
For detailed examples of utilizing [[_content/dictionary#R|RBAC]], refer to Kubernetes documentation at [https://kubernetes.io/docs/reference/access-authn-authz/rbac](https://kubernetes.io/docs/reference/access-authn-authz/rbac)
--
#### Limiting access to the Kubelets¶
Kubelets expose [[_content/dictionary#H|HTTPS]] endpoints which grant powerful control over the node and containers. By default Kubelets allow unauthenticated access to this [[_content/dictionary#A|API]]. Production clusters should enable Kubelet authentication and authorization.
...
--
### [[_content/dictionary#S|SECTION]] 3: Kubernetes Security Best Practices: Build Phase¶
...
A container image (CI) is an immutable, lightweight, standalone, executable package of software that includes everything needed to run an application: code, runtime, system tools, system libraries and settings [[https://www.docker.com/resources/what-container](https://www.docker.com/resources/what-container)]. Each image shares the kernel of the operating system present in the host machine.
...
--
#### Use A [[_content/dictionary#C|CI]] Pipeline To Control and Identify Vulnerabilities¶
...
Many source code repositories provide scanning capabilities (e.g. [Github](https://docs.github.com/en/code-security/supply-chain-security), [[[_content/dictionary#G|GitLab]]](https://docs.gitlab.com/ee/user/application_security/container_scanning/index.html)), and many CI tools offer integration with open source vulnerability scanners such as [Trivy](https://github.com/aquasecurity/trivy) or [Grype](https://github.com/anchore/grype).
Projects are developing image authorization plugins for Kubernetes that prevent unauthorized images from shipping. For more information, refer to the [[_content/dictionary#P|PR]] [https://github.com/kubernetes/kubernetes/pull/27129](https://github.com/kubernetes/kubernetes/pull/27129).
--
#### Minimize Features in All CIs¶
As a best practice, Google and other tech giants have strictly limiting the code in their runtime container for years. This approach improves the signal-to-noise of scanners (e.g. [[_content/dictionary#C|CVE]]) and reduces the burden of establishing provenance to just what you need.
...
###### [[_content/dictionary#O|OPA]] for service mesh authorization¶
...
{
  "kind": "[[_content/dictionary#N|NetworkPolicy]]",
  "metadata": {
    "name": "pol1"
  },
  "spec": {
...
### [[_content/dictionary#S|SECTION]] 5: Kubernetes Security Best Practices: Runtime Phase¶
...
A Practical Guide to Kubernetes Logging - [https://logz.io/blog/a-practical-guide-to-kubernetes-logging](https://logz.io/blog/a-practical-guide-to-kubernetes-logging)
